...
def parse_input(input_string):
    """Return `input_string` as an integer greater than 0.

    Check if `input_string` is a positive integer.
...
if __name__ == "__main__":
    ...
    num_dice_input = input("How many dice do you want to roll? [1 or more] ")
